...
# Chia điểm phê bình cho 10
df1[['Diem phe binh', 'Diem khan gia']] /= 10
...
df1.to_csv('newfilmCleanerData.csv', index=False)
print("File newfilmCleanerData.csv đã được tạo và lưu dữ liệu từ df1.")
